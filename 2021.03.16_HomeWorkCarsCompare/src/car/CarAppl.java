...
public class CarAppl {
    public static void main(String[] args) {
        Car[] cars = {
                ...
                new Car(2020, "Skoda Fabia", "Black", 4.5, 14900.50),
                new Car(2018, "Ford Mondeo", "Grey", 5.4, 20790),
                new Car(2017, "Citroen C5", "White", 4.4, 14900.60),
                new Car(2014, "Mercedes-Benz", "Rot", 5.1, 18950),
                new Car(2013, "Jaguar XF", "Black", 5.2, 14900.30),
